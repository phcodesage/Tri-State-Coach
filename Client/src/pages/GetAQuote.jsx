...
export default function GetAQuote() {
  ...
  const onSubmit = async (data) => {
    try {
      const response = await fetch('https://tri-state-backend-yt67.onrender.com/quote-request', {
        method: 'POST',
        headers: {
  ...
  return (
    ...
    <div className="mx-auto max-w-2xl text-center">
        ...
        <form action="#" method="POST" className="mx-auto mt-10 max-w-xl sm:mt-10" id="bus-requirements">
          ...
          <button onClick={() => setActiveFormHandler('contact-for-quote')} className="bg-rose-700 hover:bg-rose-500 text-white font-bold py-2 px-4 rounded">
            Continue
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} action="#" method="POST" className="mx-auto mt-10 max-w-xl sm:mt-10" id="contact-for-quote">
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            {/* Company Input */}
            <div className="sm:col-span-2">
              <label htmlFor="company" className="block text-m font-semibold leading-6 text-gray-900">Company (Optional)</label>
              <div className="mt-2.5">
                <input type="text" name="company" id="company" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-800 sm:text-m sm:leading-6" placeholder='Organization' />
              </div>
            </div>
          <div className="sm:col-span-2 mt-4">
              ...
              <div className="flex justify-between mt-4">
                ...
                <button type="submit" className="bg-rose-700 hover:bg-rose-700 text-white font-bold py-2 px-4 rounded">
                  Submit
                </button>
              </div>
          </div>
