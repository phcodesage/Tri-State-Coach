...
import TriStateCoachLogo from '../assets/tri-state-coach-logo.png'
const HamburgerMenu = () => (
  ...
  return (
    ...
    <header className="flex flex-col pl-7 w-full max-md:pl-5 max-md:max-w-full">
      <div className="flex gap-5 justify-between w-full text-base font-bold text-center text-gray-800 max-md:flex-wrap max-md:max-w-full">
        <img loading="lazy" srcSet={TriStateCoachLogo} className="max-w-full aspect-[1.14] w-[118px]" />
        <div className="flex gap-5 justify-between items-center max-md:flex-wrap max-md:max-w-full">
          <div className="max-md:mt-10">HOME</div>
          <div className="max-md:mt-10">SERVICES</div>
          <div className="flex-auto  max-md:mt-10">COLLEGE SHUTTLES</div>
          <div className="max-md:mt-10">OUR BUSES</div>
          <div className="flex-auto  max-md:mt-10">CONTACT US</div>
          <img loading="lazy" src="{HamburgerMenu}" className="self-stretch aspect-[0.83] w-[87px]" />
        </div>
      </div>
