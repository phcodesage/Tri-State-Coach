  ...
  return (
    <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl overflow-hidden rounded-lg"
         style={{ 
           ...
           backgroundSize: '100% auto', // Ensures the background scales with the width
           backgroundPosition: 'top center', 
           backgroundRepeat: 'no-repeat',
           minHeight: '390px', // Adjust based on your background image
           maxWidth: '320px'
         }}>
          <div className="flex-grow">
      <a href={ticket.link} className='flex justify-center'>
        <img className="p-8 rounded-t-lg" src={ticket.imageUrl || BearcatLogo} alt={ticket.title} />
      </a>
      <div className="px-5 pb-5">
        <div className="my-4">
          <a href={ticket.link}>
              <h5 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">{ticket.title}</h5>
          </a>
          <div className="flex items-center justify-start my-2">
              ...
              <div className="text-m font-bold text-rose-900">{ticket.date}</div>
          </div>
