...
export default function ContactUs() {
  ...
  return (
    ...
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="border ring-gray-300 flex-col justify-center items-center mt-12 lg:mt-0 lg:col-span-1 text-center">
        <h3 className="text-2xl font-bold tracking-tight text-gray-900">TRI-STATECOACH</h3>
